  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        <xsl:apply-templates/>
        <br/>
        <a href="https://gntobonb.github.io/Sab/1cap2.html" class="anterior"><xsl:text>Capítulo II</xsl:text></a>
        <a href="https://gntobonb.github.io/Sab/1cap4.html" class="siguiente"><xsl:text>Capítulo IV</xsl:text></a>
        <br/>
