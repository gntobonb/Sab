  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        <xsl:apply-templates/>
        <br/>
        <a href="https://gntobonb.github.io/Sab/nota.html" class="anterior"><xsl:text>Nota al lector</xsl:text></a>
        <a href="https://gntobonb.github.io/Sab/1cap2.html" class="siguiente"><xsl:text>Capítulo II</xsl:text></a>
        <br/>
