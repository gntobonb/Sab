  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        <xsl:apply-templates/>
        <br/>
        <a href="https://gntobonb.github.io/Sab/1cap3.html" class="anterior"><xsl:text>Capítulo III</xsl:text></a>
        <a href="https://gntobonb.github.io/Sab/1cap5.html" class="siguiente"><xsl:text>Capítulo V</xsl:text></a>
        <br/>
